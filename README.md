...
| (4) | Algoritmo de Chu-Liu/Edmonds (OPC) | ✅ Concluído | Felipe Freitas |
...
*  <a name="Felipe"></a>**Felipe Freitas** `Algoritmo de Chu-Liu/Edmonds (4)`
...
*  <a name="Giliardo"></a>**Giliardo Júlio:** `Algoritmo de Hierholzer (CICLOS) (8)` e `Algoritmo de Hierholzer (CAMINHOS) (9)`
*  <a name="Kaio"></a>**Kaio Eduardo:** `Algoritmo de Prim (2)` e `Algoritmo de Dijkstra (5)`
