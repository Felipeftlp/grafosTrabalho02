...
| (7) | Algoritmo de Floyd-Warshall | ⏳ Pendente | Pessoa 2 |
| **C. Grafos Eulerianos** | | | |
| (8) | Algoritmo de Hierholzer (CICLOS) | ⏳ Pendente | Pessoa 4 |
| (9) | Algoritmo de Hierholzer (CAMINHOS) (OPC) | ⏳ Pendente | Pessoa 4 |
